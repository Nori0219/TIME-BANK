              ...
              ? Column(
                  children: [
                    ...
                    NeonCircularTimer(
                      ...
                      width: 240.w,
                      controller:
                          widget.controller, //カウントsダウン タイマーを制御 (開始、一時停止、再開、再起動)
                      ...
                      outerStrokeColor:
                          Colors.grey.shade100, //カウントダウン ウィジェットの境界線の色
                      innerFillGradient: LinearGradient(
                          colors: [Color(0xffeee3d0), Color(0xfffac172)]),
                        ...
                        children: [
                          ...
                          animated_button.AnimatedButton(
                            ...
                            child: Padding(
                              ...
                              child: stateDate.isTimerRunning
                                  ? //時間を使うタイマーがスタートしているか
                            ...
                            onPressed: () {
                              if (stateDate.isTimerRunning == true) {
                                ...
                                print(
                                    'isStartSepedingTimer:${stateDate.isTimerRunning}');
                                ...
                                notifier.scheduleLocalNotification(
                                    TimerModel.spendTime);
                              }
                            },
                            shadowDegree: ShadowDegree.light,
    ...
    return Stack(
      children: <Widget>[
        ...
        Container(
          ...
          height: 110.h,
          child:
              Lottie.asset('assets/animation/topWave2.json', fit: BoxFit.cover),
        ),
        Container(
            //color: Colors.amberAccent,
