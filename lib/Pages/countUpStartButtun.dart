...
class CountUpStartButtun extends StatefulWidget {

  @override
  State createState() => CountUpStartButtunState();
}

class CountUpStartButtunState extends State<CountUpStartButtun> {
  // final _isHours = true;
